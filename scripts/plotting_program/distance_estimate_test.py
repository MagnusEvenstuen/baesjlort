...
for idx, method in enumerate(methods):
    ...
    # Plot average data hvis den finnes
    ...
    # Legg til tekstboks med statistikk
    if method['data_avg'] is not None and len(method['data_avg']) > 0:
        # Beregn gjennomsnittlig feil
...
plt.title('Precision in distance estimates (Lower value is better)', fontsize=14)
